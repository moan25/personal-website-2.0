...
网站已通过 GitHub Pages 发布为公共 HTTPS 网页：

**[打开个人项目档案](https://moan25.github.io/personal-website-2.0/)**

访问者不需要安装 Node.js，也不需要启动本地服务。项目详情、媒体库、图片灯箱、视频播放和开场动画均从该地址加载。

## 本机开发

安装 Node.js 22.12 以上版本，推荐当前 Node.js 24。双击 `start-website.cmd`，访问 http://127.0.0.1:5174/。脚本按需构建，后台隐藏运行，再次启动复用本项目实例。该地址只能用于本机测试，不是分享链接。
